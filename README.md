...
我相信**工具是思维的延伸**，因此我热衷于开发或改造各类工具（如 jadx, Frida, IDA, unicorn/unidbg，MCP），致力于构建一个更智能、**更自动化**的逆向工程工作流。(目标是让ai全自动化逆向）

我同样热衷于**知识的沉淀与分享**，这能让我与社区共同成长。所以如果你需要和我交流或者答疑服务，可以看下面：
